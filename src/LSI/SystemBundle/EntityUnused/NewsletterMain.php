 ...
 * NewsletterMain
 *
 * @ORM\Table(name="newsletter_main", indexes={@ORM\Index(name="FK__newslette__summe__5D4BCC77", columns={"summer_sales_week_id"})})
 * @ORM\Entity
 */
class NewsletterMain
{
     ...
     * @var integer
     *
     * @ORM\Column(name="newsletter_main_id", type="integer")
     * @ORM\Id
