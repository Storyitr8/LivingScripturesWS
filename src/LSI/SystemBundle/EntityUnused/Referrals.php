...
class Referrals
{
     ...
     * @var boolean
     *
     * @ORM\Column(name="referral_status", type="boolean", nullable=true)
     */
     ...
     * @var boolean
     *
     * @ORM\Column(name="referral_rank", type="boolean", nullable=true)
     */
     ...
     * @var integer
     *
     * @ORM\Column(name="referral_id", type="bigint")
     * @ORM\Id
