 ...
 * CustomerMain
 *
 * @ORM\Table(name="customer_main", indexes={@ORM\Index(name="fk_customermain_annualincome", columns={"annual_income_id"}), @ORM\Index(name="fk_customermain_billingstateprov", columns={"billing_state_prov"}), @ORM\Index(name="fk_customermain_shippingstateprov", columns={"shipping_state_prov"})})
 * @ORM\Entity
 */
class CustomerMain
{
     ...
     * @var boolean
     *
     * @ORM\Column(name="kids_age_from", type="boolean", nullable=true)
     */
    private $kidsAgeFrom;
     ...
     * @var boolean
     *
     * @ORM\Column(name="kids_age_to", type="boolean", nullable=true)
     */
    private $kidsAgeTo;
     ...
     * @var boolean
     *
     * @ORM\Column(name="age_youngest_child", type="boolean", nullable=true)
     */
     ...
     * @var integer
     *
     * @ORM\Column(name="customer_main_id", type="integer")
     * @ORM\Id
    ...
    /**
     * @var \LSI\SystemBundle\Entity\AnnualIncome
     *
     * @ORM\ManyToOne(targetEntity="LSI\SystemBundle\Entity\AnnualIncome")
     * @ORM\JoinColumns({
     ...
     *
     * @param boolean $ageYoungestChild
     * @return CustomerMain
     */
     ...
     *
     * @param \LSI\SystemBundle\Entity\StateProv $shippingStateProv
     * @return CustomerMain
     */
     ...
     *
     * @param \LSI\SystemBundle\Entity\StateProv $billingStateProv
     * @return CustomerMain
     */
     ...
     * Set annualIncome
     *
     * @param \LSI\SystemBundle\Entity\AnnualIncome $annualIncome
     * @return CustomerMain
     */
     ...
     * Get annualIncome
     *
     * @return \LSI\SystemBundle\Entity\AnnualIncome 
     */
