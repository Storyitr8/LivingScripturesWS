...
class ImportedReportCommission
{
     ...
     * @var string
     *
     * @ORM\Column(name="`override-comm`", type="decimal", precision=18, scale=2, nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="`base-comm`", type="decimal", precision=18, scale=2, nullable=true)
     */
    private $baseComm;
     ...
     * @var string
     *
     * @ORM\Column(name="`upfront-pay`", type="decimal", precision=18, scale=2, nullable=true)
     */
    private $upfrontPay;
