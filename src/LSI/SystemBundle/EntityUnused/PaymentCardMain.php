 ...
 * PaymentCardMain
 *
 * @ORM\Table(name="payment_card_main", indexes={@ORM\Index(name="fk_paymentcardinfo_ordermain", columns={"order_main_id"}), @ORM\Index(name="fk_paymentcardinfo_customermain", columns={"customer_main_id"})})
 * @ORM\Entity
 */
class PaymentCardMain
{
     ...
     * @var integer
     *
     * @ORM\Column(name="payment_card_main_id", type="integer")
     * @ORM\Id
