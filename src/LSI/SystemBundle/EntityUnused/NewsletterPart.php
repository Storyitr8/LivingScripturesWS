 ...
 * NewsletterPart
 *
 * @ORM\Table(name="newsletter_part", indexes={@ORM\Index(name="FK__newslette__newsl__63F8CA06", columns={"newsletter_part_approved_by_userid"}), @ORM\Index(name="FK__newslette__newsl__6304A5CD", columns={"newsletter_main_id"})})
 * @ORM\Entity
 */
class NewsletterPart
{
     ...
     * @var boolean
     *
     * @ORM\Column(name="newsletter_part_sort_order", type="boolean", nullable=true)
     */
     ...
     * @var integer
     *
     * @ORM\Column(name="newsletter_part_id", type="integer")
     * @ORM\Id
    ...
    /**
     * @var \LSI\SystemBundle\Entity\NewsletterMain
     *
     * @ORM\ManyToOne(targetEntity="LSI\SystemBundle\Entity\NewsletterMain")
     * @ORM\JoinColumns({
     ...
     *
     * @param boolean $newsletterPartSortOrder
     * @return NewsletterPart
     */
     ...
     * Set newsletterMain
     *
     * @param \LSI\SystemBundle\Entity\NewsletterMain $newsletterMain
     * @return NewsletterPart
     */
     ...
     * Get newsletterMain
     *
     * @return \LSI\SystemBundle\Entity\NewsletterMain 
     */
     ...
     *
     * @param \LSI\SystemBundle\Entity\UserMain $newsletterPartApprovedByUserid
     * @return NewsletterPart
     */
