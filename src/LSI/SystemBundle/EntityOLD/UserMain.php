...
class UserMain implements UserInterface, \Serializable
{
     ...
     *
     ** @ORM\ManyToMany(targetEntity="UserTeam", inversedBy="userid")
    ...
    /**
     * @ORM\Column(name="reset_pass_token", type="string")
     */
    protected $resetPassToken;

    /**
     * @ORM\Column(name="reset_pass_token_expires", type="datetime")
     */
    protected $resetPassTokenExpires;
    ...
    {
        return $this->isActive?'Active Users':'Inactive Users';
    }
    ...
    {
        if($this->picture != null && $this->pictureFileType != null){
            return $this->picture . '.'.$this->pictureFileType;
        }
    ...
    public function setResetPassToken($resetPassToken) {
        $this->resetPassToken = $resetPassToken;
        return $this;
    }

    public function getResetPassTokenExpires() {
        return $this->resetPassTokenExpires;
    }

    public function setResetPassTokenExpires($resetPassTokenExpires) {
        $this->resetPassTokenExpires = $resetPassTokenExpires;
    }

    public function generateResetToken()
    {
        $this->resetPassToken = uniqid(null, true);
        $this->resetPassTokenExpires = new \DateTime('now +1 day');
        return $this->resetPassToken;
    }
