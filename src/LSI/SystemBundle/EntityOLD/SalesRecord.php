...
class SalesRecord
{
     ...
     *** @var integer
     *
     ** @ORM\Column(name="sales_record_id", type="integer", nullable=false)
     ** @ORM\Id
     ...
     *** @var float
     *
     ** @ORM\Column(name="record_value", type="decimal", precision=10, scale=4, nullable=false)
     */
    private $recordValue;
     ...
     *** @var \SalesRecordType
     *
     ** @ORM\ManyToOne(targetEntity="SalesRecordType")
     ** @ORM\JoinColumns({
     ...
     * Set salesRecordType
     *
     ** @param \SalesRecordType $salesRecordType
     ** @return SalesRecord
     */
     ...
     *
     ** @param \UserRole $recordHolderUserRole
     ** @return SalesRecord
     */
