 ...
 * NewsletterPartVideo
 *
 ** @ORM\Table(name="newsletter_part_video")
 ** @ORM\Entity
 */
class NewsletterPartVideo
{
     ...
     *** @var integer
     *
     ** @ORM\Column(name="newsletter_part_video_id", type="integer", nullable=false)
     ** @ORM\Id
     ...
     *** @var \NewsletterPart
     *
     ** @ORM\ManyToOne(targetEntity="NewsletterPart")
     ** @ORM\JoinColumns({
     ...
     * Set newsletterPart
     *
     ** @param \NewsletterPart $newsletterPart
     ** @return NewsletterPartVideo
     */
